...
public class PermissionInformationMineducActivity extends PreyActivity {
	...
	private void showScreen(){
		...
		ok.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(PermissionInformationMineducActivity.this, LoginActivity.class);
