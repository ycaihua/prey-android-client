...
public class AddDeviceToAccountActivity extends SetupActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// findViewById(R.layout.add_device);
		...
		// final EditText newAccountName = (EditText)
		// findViewById(R.id.new_account_name);
		...
		iconBack.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = null;
				intent = new Intent(AddDeviceToAccountActivity.this, LoginActivity.class);
		...
		protected Void doInBackground(String... data) {
			try {
				...
				try {
					...
					PreyLogger.d(noMoreDevices.getMessage());
