...
public class AddDeviceToAccountMineducActivity extends SetupActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.add_device_mineduc);
		...
		ok.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (email.equals("") || password.equals("")) {
					Toast.makeText(AddDeviceToAccountMineducActivity.this, R.string.error_all_fields_are_required, Toast.LENGTH_LONG).show();
				} else {
	...
	protected Dialog onCreateDialog(int id) {
		...
		case ERROR:
			return new AlertDialog.Builder(AddDeviceToAccountMineducActivity.this).setIcon(R.drawable.error).setTitle(R.string.error_title).setMessage(error)
		...
		case NO_MORE_DEVICES_WARNING:
			return new AlertDialog.Builder(AddDeviceToAccountMineducActivity.this).setIcon(R.drawable.info).setTitle(R.string.set_old_user_no_more_devices_title)
	...
	private class AddDeviceToAccount extends AsyncTask<String, Void, Void> {
		...
		protected void onPreExecute() {
			progressDialog = new ProgressDialog(AddDeviceToAccountMineducActivity.this);
			progressDialog.setMessage(AddDeviceToAccountMineducActivity.this.getText(R.string.set_old_user_loading).toString());
		...
		protected Void doInBackground(String... data) {
			try {
				...
				error = null;
				PreyAccountData accountData = PreyWebServices.getInstance().registerNewDeviceToAccountMineduc(AddDeviceToAccountMineducActivity.this, data[0], data[1],
						data[2]);
		...
		protected void onPostExecute(Void unused) {
			...
			if (noMoreDeviceError)
				...
				if (error == null) {
					...
					PreyConfig.getPreyConfig(AddDeviceToAccountMineducActivity.this).setCamouflageSet(true);
					Intent intent = new Intent(AddDeviceToAccountMineducActivity.this, PermissionInformationMineducActivity.class);
