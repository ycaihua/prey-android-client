...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    public void onCreate() {
        ...
        PreyLogger.i("___________________");
        PreyLogger.i("___________________");
        PreyLogger.i("PreyGeofenceTransitionsIntentService onCreate");
    }
    ...
    private void notifyGeofenceTransition(
        ...
        PreyLogger.i("___________________");
        PreyLogger.i("___________________");
        PreyLogger.i("notifyGeofenceTransition:"+geofenceTransition);

        ArrayList triggeringGeofencesIdsList = new ArrayList();
        for (Geofence geofence : triggeringGeofences) {
            PreyLogger.i("geofence.getRequestId():"+geofence.getRequestId());
            ...
            try {
                ...
                PreyLogger.i("notifyGeofenceTransition error:"+e.getMessage());
            }
        }
